...
import { consultarDatabase, consultarDocumentoWhere, guardarDatabase, eliminarDocumentoDatabase } from '../config/firebase';
...
export const ListaVentas = () => {
    ...
    useEffect (async ()=>{
        ...
        const respuestaProductos = await consultarDatabase('ng_productos')
        console.log("Esta es la consulta a productos: ",respuestaProductos);
        let productosBD = [];

        respuestaProductos.forEach(item =>
            console.log("este es un producto: ", item),
